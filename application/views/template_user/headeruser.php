...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: grey;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: mocca;">
            <!-- Brand Logo -->
            <a href="<?php echo base_url('C_dashboarduser') ?>" class="brand-link" style="background-color: mocca;">
