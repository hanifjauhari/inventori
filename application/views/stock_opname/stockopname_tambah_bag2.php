        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-3">
                    ...
                    <form action="<?php echo site_url('C_stockopname/prosessimpanopname') ?>" method="POST">


                        <input type="hidden" name="tanggal" value="<?php echo $this->input->get('tanggal') ?>">
                        <input type="hidden" name="jenis_opname" value="<?php echo $this->input->get('jenis_opname') ?>">
                        <input type="hidden" name="penanggung_jawab" value="<?php echo $this->input->get('penanggung_jawab') ?>">


                        <div class="card card-body">

                            <h4>Form Tambah Stock Opname Bagian 2</h4>
